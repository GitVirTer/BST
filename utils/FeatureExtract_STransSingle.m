...
%% Main function
function [NewData,t,f] = FeatureExtract_STransSingle(data,sample_freq,freqRange,freqSamp,pp1,sqzSize, outputMode)
...
[data_st,t,f] = ast(data',minFreq,maxFreq,1/sample_freq,freqInterval,pp1);
